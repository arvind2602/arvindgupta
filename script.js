...
var contactString =
  "<div class='social'> <a href='mailto:guptaarvind2602@gmail.com'> <div class='socialItem'><img class='socialItemI' src='images/gmail.svg' alt=''></div> </a> <a target='_blank' href='https://github.com/arvind2602'> <div class='socialItem'><img class='socialItemI' src='images/github.svg' alt=''></div> </a> <a href='https://www.linkedin.com/in/arvind-gupta-147ba0184/' target='_blank' rel='noopener noreferrer'> <div class='socialItem'><img class='socialItemI' src='images/linkedin.svg' alt=''></div> </a> </div>";
var resumeString =
...
function waitAndResponce(inputText) {
  ...
  switch (inputText.toLowerCase().trim()) {
    ...
    case "achievements":
      sendTextMessage(
        "I emerged victorious 🥇 in the esteemed Smart India Hackathon of 2022! 🎉✨ My team and I put our minds to work, solving complex challenges and crafting innovative solutions. 💪💡 <br> <br>  🌍🌍 I also had the honor of being a finalist 🏆 in the UNESCO Indian Africa International Hackathon, where talented minds from 25 different countries came together to tackle global issues. 🌎💪"
      );
      break;
    ...
    case "about":
      sendTextMessage(
        "🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by <a class='alink' target='_blank' href='https://www.linkedin.com/in/arvind-gupta-147ba0184/'><span class='bold'>Arvind Gupta</a> with ❤️</span>"
      );
      break;
    case "contact":
